...
import com.inc.vr.corp.app.quranwidget.viewmodel.MasjidViewModel
...
class MasjidActivity : AppCompatActivity(), OnMapReadyCallback {
    private val TAG = MasjidActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title="Masjid Terdekat"
